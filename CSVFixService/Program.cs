...
static class Program
{
    static void Main(string[] args)
    {
        ...
        var txt = AuthenticatedFileAccess.ReadAllLinesAuthenticated(@"\\51.12.57.16\drive\Minceraft.txt", ".\\jonas", "Unsertschali-1");
        //var txt = AuthenticatedFileAccess.ReadAllLinesAuthenticated("Z:\\Minceraft.txt", null, null);
